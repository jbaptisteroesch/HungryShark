...
local text = {}
if not pcall(function () text.infotitlefont = love.graphics.newFont("assets/murder.ttf", 100) end) then
  print("Could not load 'murder.ttf' font.")
  return 2
end
if not pcall(function () text.infoinfofont = love.graphics.newFont("assets/murder.ttf", 60) end) then
  print("Could not load 'murder.ttf' font.")
  return 2
end
